...
enum Strings {
    ...
    // STORE-2 §4: About's licence, source and privacy rows, and the licence page.
    static let settingsBuild = String(localized: "settings.build", defaultValue: "构建")
    static let settingsLicence = String(localized: "settings.licence", defaultValue: "许可证 · GPL-3.0")
    static let settingsLicenceDetail = String(localized: "settings.licenceDetail", defaultValue: "组件清单和 GPL 全文")
    static let settingsSourceCode = String(localized: "settings.sourceCode", defaultValue: "源代码")
    static let settingsPrivacy = String(localized: "settings.privacy", defaultValue: "隐私")
    static let licenceCombined = String(localized: "licence.combined", defaultValue: "Moonlight 和 LibVNCClient 按 GPL 授权并编进了同一个 App，所以整个 App 按 GPL-3.0 分发。你可以在上面的源代码地址拿到构建这个版本的全部源码。")
    static let licenceComponents = String(localized: "licence.components", defaultValue: "App 里带的组件")
    static let licenceComponentsNote = String(localized: "licence.componentsNote", defaultValue: "这份清单读自 App 内附带的 docs/THIRD-PARTY.md，和源码仓库里的是同一个文件。")
    static let licenceFullText = String(localized: "licence.fullText", defaultValue: "GNU GPL 第 3 版全文")
    static let licenceUnreadable = String(localized: "licence.unreadable", defaultValue: "App 包里读不到这个文件。")
    ...
    static let demoEnter = String(localized: "demo.enter", defaultValue: "看看演示")
